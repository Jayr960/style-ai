  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-6">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 h-[500px] w-[500px] rounded-full opacity-15" style={{ background: "radial-gradient(circle, #7c3aed 0%, transparent 70%)" }} />
        <div className="absolute bottom-1/4 right-1/4 h-[400px] w-[400px] rounded-full opacity-10" style={{ background: "radial-gradient(circle, #ff4d6d 0%, transparent 70%)" }} />
      </div>
        ...
        <GlassCard hover={false} className="p-8">
          <div className="relative z-10">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {isSignUp ? "Start building your AI wardrobe" : "Sign in to your wardrobe"}
            </p>
            ...
            <motion.button
              ...
              className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-secondary py-3 text-sm font-medium text-foreground transition-colors hover:bg-muted"
              whileTap={{ scale: 0.98 }}
            >
            ...
            <p className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <button onClick={() => setIsSignUp(!isSignUp)} className="text-violet font-medium hover:underline">
